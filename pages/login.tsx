...
import { loginApi, saveAuth, isAuthenticated } from '@/services/api';
 ...
 *   - On success: saves token in cookie, redirects to /post-job
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.status && response.data) {
        ...
        // Redirect to post-job page (same as legacy)
        setTimeout(() => {
